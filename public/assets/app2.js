...
import { g as geral, s as singlePjaxInstance, a as getDefaultExportFromCjs, c as commonjsGlobal, m as manualModalClose } from "./pjax.js";
import { t as toElement, D as DataSetGet } from "./data-set-get.js";
import { s as screen } from "./screen-size.js";
import { e as elementOuterSize, a as elementIndex, c as createElementIfNotDefined, b as elementParents, S as Swiper, N as Navigation } from "./navigation.js";
var require_app2 = __commonJS({
  "assets/app2.js"(exports, module) {
    const defaultConfig = {
      ...
      load: function load(a2) {
        ...
        "iframe" === a2.nodeName.toLowerCase() && a2.getAttribute("data-src") && (a2.setAttribute("src", a2.getAttribute("data-src")), a2.setAttribute("data-loaded", "true"));
        if ("video" === a2.nodeName.toLowerCase() && !a2.getAttribute("data-src") && a2.children) {
          a2.setAttribute("poster", a2.getAttribute("data-poster"));
          b = a2.children;
          for (var d2, c2 = 0; c2 <= b.length - 1; c2++)
            if (d2 = b[c2].getAttribute("data-src"))
              b[c2].src = d2;
          a2.load();
        }
        a2.getAttribute("data-src") && (a2.src = a2.getAttribute("data-src"));
        a2.getAttribute("data-srcset") && a2.setAttribute("srcset", a2.getAttribute("data-srcset"));
        a2.getAttribute("data-background-image") && (a2.style.backgroundImage = "url('" + a2.getAttribute("data-background-image") + "')");
        a2.getAttribute("data-toggle-class") && a2.classList.toggle(a2.getAttribute("data-toggle-class"));
      },
    ...
    function observers() {
      ...
      let playObserver = new IntersectionObserver(function(entries, playObserver2) {
        entries.forEach(function(entry) {
          var slide = document.querySelector("#" + entry.target.id + " .swiper-container").swiper;
    ...
    class PageController {
      ...
      updateCurrent() {
        const pg = this.pages.find((e2) => e2.pageName.includes(geral.currentPageId));
        if (!pg) {
    ...
    function main$8() {
      ...
      let containerCreateAccount = document.querySelector(".container-create-account");
      recalcWrapperHeight();
      ...
      if (screen.isDesktop) {
        ...
        document.addEventListener("pjax:switch", function() {
          window.removeEventListener("orientationchange", recalcWrapperHeight);
        }, { once: true });
      }
      if (!screen.isDesktop) {
      ...
      function recalcInputHeight() {
        let wrapperInput = document.querySelector(".container-select-specify-other .wrapper-input");
        if (!wrapperInput)
          return;
        let wrapperForm2 = document.querySelector(".wrapper-form");
        if (!wrapperForm2)
    ...
    class ModalGroup extends HTMLElement {
      ...
      open(name) {
        ...
        const item = name ? children.find((c2) => c2.name == name) : children[0];
    ...
    function inputMoney(input) {
      ...
      function formatInput() {
        ...
        const l2 = n2.length;
        let c2 = input.selectionStart - input.value.replace(/[^,.]/g, "").length;
        let newValue = "";
        if (l2 > 2) {
    ...
    function Contato() {
      let forms = document.querySelectorAll(".container-contato:not(.js-running)");
      forms.forEach((formContato) => {
        formContato.classList.add("js-running");
        formContato.querySelector("form").addEventListener("submit", function(e2) {
          e2.preventDefault();
          formContato.querySelector(".feedback-contato").classList.add("d-none");
          formContato.querySelector(".submit-text").innerHTML = VARS.contactSending;
          formContato.querySelector(".bt-submit").classList.add("pointer-events-none");
          fetch(VARS.contactURL, {
            ...
            if (data.ok) {
              ...
              formContato.querySelector(".feedback-contato").classList.remove("d-none");
              formContato.querySelector(".feedback-contato").innerHTML = VARS.contactSent;
            } else {
              formContato.querySelector(".submit-text").innerHTML = VARS.contactSend;
              formContato.querySelector(".feedback-contato").innerHTML = VARS.contactError;
              formContato.querySelector(".feedback-contato").classList.remove("d-none");
              formContato.querySelector(".bt-submit").classList.remove("pointer-events-none");
            }
    ...
    */
    var _config$1 = {
      ...
      overwrite: false,
      delay: 0
    }, _suppressOverwrites$1, _reverting$1, _context$2, _bigNum$1 = 1e8, _tinyNum = 1 / _bigNum$1, _2PI = Math.PI * 2, _HALF_PI = _2PI / 4, _gsID = 0, _sqrt = Math.sqrt, _cos = Math.cos, _sin = Math.sin, _isString$2 = function _isString2(value) {
      ...
      return (v2 = target[property]) && _isFunction$2(v2) ? target[property]() : _isUndefined(v2) && target.getAttribute && target.getAttribute(property) || v2;
      ...
      return _conditionalReturn(value, !isArray2 ? _roundModifier(snapTo) : _isFunction$2(snapTo) ? function(raw) {
        ...
        var x2 = parseFloat(is2D ? raw.x : raw), y2 = parseFloat(is2D ? raw.y : 0), min2 = _bigNum$1, closest = 0, i2 = snapTo.length, dx, dy;
        while (i2--) {
          if (is2D) {
            dx = snapTo[i2].x - x2;
            dy = snapTo[i2].y - y2;
      ...
      if (!func) {
        var isString2 = _isString$2(start), master = {}, p2, i2, interpolators, l2, il;
      ...
      var v2 = animation.vars, callback = v2[type], prevContext = _context$2, context = animation._ctx, params, scope, result;
      if (!callback) {
        return;
      }
      ...
      var a2 = !v2 ? _colorLookup.black : _isNumber$1(v2) ? [v2 >> 16, v2 >> 8 & _255, v2 & _255] : 0, r2, g2, b2, h2, s2, l2, max2, min2, d2, wasHSL;
      if (!a2) {
        if (v2.substr(-1) === ",") {
      ...
      if (toHSL && !wasHSL) {
        ...
        if (max2 === min2) {
          ...
          h2 = max2 === r2 ? (g2 - b2) / d2 + (g2 < b2 ? 6 : 0) : max2 === g2 ? (b2 - r2) / d2 + 2 : (r2 - g2) / d2 + 4;
          h2 *= 60;
        }
        a2[0] = ~~(h2 + 0.5);
        a2[1] = ~~(s2 * 100 + 0.5);
    ...
    var Timeline = /* @__PURE__ */ function(_Animation) {
      ...
      _proto2.totalDuration = function totalDuration(value) {
        var max2 = 0, self2 = this, child = self2._last, prevStart = _bigNum$1, prev, start, parent2;
        if (arguments.length) {
    ...
    var _gsap = {
      ...
      quickTo: function quickTo(target, property, vars) {
        var _merge2;
        var tween = gsap$3.to(target, _merge((_merge2 = {}, _merge2[property] = "+=0.1", _merge2.paused = true, _merge2), vars || {})), func = function func2(value, start, startIsRelative) {
    ...
    */
    var _win$2, _doc$2, _docElement, _pluginInitted, _tempDiv, _recentSetterPlugin, _reverting, _windowExists$2 = function _windowExists2() {
      ...
      */
      ...
      var cap = 360, isString2 = _isString$2(endValue), endNum = parseFloat(endValue) * (isString2 && ~endValue.indexOf("rad") ? _RAD2DEG : 1), change = endNum - startNum, finalValue = startNum + change + "deg", direction, pt2;
      if (isString2) {
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var gsap$2, _coreInitted$2, _win$1, _doc$1, _docEl$2, _body$2, _isTouch, _pointerType, ScrollTrigger$2, _root$1, _normalizer$1, _eventTypes, _context$1, _getGSAP$2 = function _getGSAP2() {
      ...
      _scrollers[i2 + offset2] || _addListener$1(element, "scroll", _onScroll$1);
      var prev = _scrollers[i2 + offset2], func = prev || (_scrollers[i2 + offset2] = _scrollCacheFunc(_getProxyProp(element, s2), true) || (_isViewport$1(element) ? sc : _scrollCacheFunc(function(value) {
    ...
    var Observer = /* @__PURE__ */ function() {
      ...
      _proto.init = function init(vars) {
        ...
        var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self2 = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY2 = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport$1(target), ownerDoc = target.ownerDocument || _doc$1, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
          ...
          onDelta((x2 - scrollX) * scrollSpeed, (y2 - scrollY2) * scrollSpeed, 1);
          scrollX = x2;
          scrollY2 = y2;
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var gsap$1, _coreInitted$1, _window, _docEl$1, _body$1, _toArray$1, _config, ScrollTrigger$1, _windowExists$1 = function _windowExists2() {
      return typeof window !== "undefined";
      ...
      if (typeof value !== "object") {
        ...
        var result = {}, p2;
        for (p2 in value) {
          result[p2] = p2 !== "onAutoKill" && _isFunction$1(value[p2]) ? value[p2](index, target, targets) : value[p2];
        }
        return result;
      }
    ...
    var ScrollToPlugin = {
      ...
      init: function init(target, value, tween, index, targets) {
        ...
        ScrollTrigger$1 || (ScrollTrigger$1 = gsap$1.core.globals().ScrollTrigger);
      ...
      render: function render(ratio, data) {
        var pt2 = data._pt, target = data.target, tween = data.tween, autoKill = data.autoKill, xPrev = data.xPrev, yPrev = data.yPrev, isWin = data.isWin, snap2 = data.snap, snapInline = data.snapInline, x2, y2, yDif, xDif, threshold;
        while (pt2) {
          pt2.r(ratio, pt2.d);
          pt2 = pt2._next;
        }
    ...
    */
    var gsap, _coreInitted, _win, _doc, _docEl, _body, _root, _resizeDelay, _toArray, _clamp, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp2(value, type, self2) {
      ...
      return Math.max(0, (s2 = "scroll" + d2) && (a2 = _getProxyProp(element, s2)) ? a2() - _getBoundsFunc(element)()[d3] : _isViewport(element) ? (_docEl[s2] || _body[s2]) - _getViewportDimension(d2) : element[s2] - element["offset" + d2]);
      ...
      var snap2 = gsap.utils.snap(snapIncrementOrArray), a2 = Array.isArray(snapIncrementOrArray) && snapIncrementOrArray.slice(0).sort(function(a3, b2) {
        return a3 - b2;
      });
      ...
      var e2 = _doc.createElement("div"), useFixedPosition = _isViewport(container) || _getProxyProp(container, "pinType") === "fixed", isScroller = type.indexOf("scroller") !== -1, parent2 = useFixedPosition ? _body : container, isStart = type.indexOf("start") !== -1, color = isStart ? startColor : endColor, css = "border-color:" + color + ";font-size:" + fontSize + ";color:" + color + ";font-weight:" + fontWeight + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
    ...
    }, _prefixExp = /(webkit|moz|length|cssText|inset)/i, _reparent = function _reparent2(element, parent2, top2, left) {
    ...
    var ScrollTrigger = /* @__PURE__ */ function() {
      ...
      _proto.init = function init(vars, animation) {
        ...
        if (snap2) {
          ...
          _scrollers.forEach(function(o2) {
            return _isFunction(o2) && o2.target === (isViewport ? _doc.scrollingElement || _docEl : scroller) && (o2.smooth = false);
          });
          snapFunc = _isFunction(snap2.snapTo) ? snap2.snapTo : snap2.snapTo === "labels" ? _getClosestLabel(animation) : snap2.snapTo === "labelsDirectional" ? _getLabelAtDirection(animation) : snap2.directional !== false ? function(value, st2) {
            return _snapDirectional(snap2.snapTo)(value, _getTime() - lastRefresh < 500 ? 0 : st2.direction);
          ...
          snapDelayedCall = gsap.delayedCall(snap2.delay || scrubSmooth / 2 || 0.1, function() {
        ...
        self2.refresh = function(soft, force, position, pinOffset) {
          ...
          var size = getScrollerSize(), scrollerBounds = getScrollerOffsets(), max2 = containerAnimation ? containerAnimation.duration() : _maxScroll(scroller, direction), isFirstRefresh = change <= 0.01, offset3 = 0, otherPinOffset = pinOffset || 0, parsedEnd = _isObject(position) ? position.end : vars.end, parsedEndTrigger = vars.endTrigger || trigger, parsedStart = _isObject(position) ? position.start : vars.start || (vars.start === 0 || !trigger ? 0 : pin ? "0 0" : "0 100%"), pinnedContainer = self2.pinnedContainer = vars.pinnedContainer && _getTarget(vars.pinnedContainer, self2), triggerIndex = trigger && Math.max(0, _triggers.indexOf(self2)) || 0, i2 = triggerIndex, cs2, bounds, scroll, isVertical, override, curTrigger, curPin, oppositeScroll, initted, revertedPins, forcedOverflow, markerStartOffset, markerEndOffset;
          ...
          if (_isString(parsedEnd) && !parsedEnd.indexOf("+=")) {
            if (~parsedEnd.indexOf(" ")) {
              ...
              parsedEnd = _isString(parsedStart) ? parsedStart : (containerAnimation ? gsap.utils.mapRange(0, containerAnimation.duration(), containerAnimation.scrollTrigger.start, containerAnimation.scrollTrigger.end, start) : start) + offset3;
              parsedEndTrigger = trigger;
            }
          }
          parsedEnd = _parseClamp(parsedEnd, "end", self2);
          end = Math.max(start, _parsePosition(parsedEnd || (parsedEndTrigger ? "100% 0" : max2), parsedEndTrigger, size, direction, scrollFunc() + offset3, markerEnd, markerEndTrigger, self2, scrollerBounds, borderWidth, useFixedPosition, max2, containerAnimation, self2._endClamp && "_endClamp")) || -1e-3;
          offset3 = 0;
          i2 = triggerIndex;
          while (i2--) {
            curTrigger = _triggers[i2];
      ...
      ScrollTrigger2.scrollerProxy = function scrollerProxy(target, vars) {
        var t2 = _getTarget(target), i2 = _scrollers.indexOf(t2), isViewport = _isViewport(t2);
        if (~i2) {
    ...
    gsapWithCSS$1.registerPlugin(ScrollTrigger, Power3, Power0, ScrollToPlugin, Back);
    function Parallax() {
      let parallaxes = document.querySelectorAll("[data-parallax]:not(.js-running)");
      parallaxes.forEach((element) => {
        ...
        let trigger = element.dataset.trigger ? document.querySelector(element.dataset.trigger) : element;
        let endTrigger = element.dataset.endTrigger ? document.querySelector(element.dataset.endTrigger) : trigger;
        ...
        let start = element.dataset.start ? element.dataset.start : "top bottom";
        ...
        if (element.dataset.parallaxTop) {
          ...
          start = element.dataset.start ? element.dataset.start : window.innerHeight + " top";
          end = element.dataset.end ? element.dataset.end : window.innerHeight * 2 + " top";
          markers = true;
        }
        ...
        animation.fromTo(element, { y: yFrom, x: xFrom, rotate: rotateFrom, opacity: opacityFrom, scale: scaleFrom, force3D: true }, { y: yTo, x: xTo, rotate: rotateTo, scale: scaleTo, duration, delay: 0, opacity, ease, transformOrigin: "center center" });
      });
      let parallaxesTop = document.querySelectorAll("[data-parallax-top]:not(.js-running)");
      parallaxesTop.forEach((element) => {
        ...
        let repeat = element.dataset.repeat ? element.dataset.repeat : 0;
        let yoyo = element.dataset.yoyo ? element.dataset.yoyo : false;
        let trigger = element.dataset.trigger ? document.querySelector(element.dataset.trigger) : document.querySelector(".wrapper");
        let endTrigger = element.dataset.endTrigger ? document.querySelector(element.dataset.endTrigger) : trigger;
        let ease = element.dataset.ease ? element.dataset.ease : "Power0.easeInOut";
        let delay = element.dataset.delay ? element.dataset.delay : 0;
        let repeatDelay = element.dataset.repeatDelay ? element.dataset.repeatDelay : 0;
        ...
        let end = element.dataset.end ? element.dataset.end : window.innerHeight + " top";
        let markers = false;
        if (element.dataset.trigger && element.dataset.trigger == "parent")
          trigger = element.parentElement;
        let scrub = element.dataset.repeat && element.dataset.repeat == "-1" ? false : true;
    ...
    function scrollTo(headerDesktop, headerMobile) {
      ...
      scrollToArray.forEach((element) => {
        ...
        element.addEventListener("click", function(ev) {
          ...
          if (targetId === "0") {
            gsapWithCSS.to(window, { scrollTo: 0, duration: 0.8, ease: "power2.out" });
          } else {
            let targetElement = document.querySelector(`#${targetId}`);
            if (targetElement) {
              let offsetY = header ? document.querySelector(header).offsetHeight : 0;
              gsapWithCSS.to(window, { scrollTo: { y: targetElement, offsetY }, duration: 0.8, ease: "power2.out" });
            } else {
              ...
              document.addEventListener("pjax:complete", function() {
                ...
                if (newTargetElement) {
                  let offsetY = header ? document.querySelector(header).offsetHeight : 0;
                  gsapWithCSS.to(window, { scrollTo: { y: newTargetElement, offsetY }, duration: 0.8, ease: "power2.out" });
                }
              }, { once: true });
            }
          }
    ...
    function Forms() {
      ...
      forms.forEach((containerForm) => {
        ...
        containerForm.querySelector("form").addEventListener("submit", function(e2) {
          e2.preventDefault();
          {
      ...
      if (screen.isDesktop) {
        var containerSelect, i2, j2, containerSelectList, ll, selectContent, selected, select, option;
        ...
        if (containerSelect) {
          ...
          for (i2 = 0; i2 < containerSelectList; i2++) {
            ...
            selectContent = containerSelect[i2].getElementsByTagName("select")[0];
            ...
            for (j2 = 1; j2 < ll; j2++) {
              ...
              option.addEventListener("click", function(e2) {
                ...
                s2 = this.parentNode.parentNode.getElementsByTagName("select")[0];
                sl = s2.length;
                ...
                for (i3 = 0; i3 < sl; i3++) {
                  if (s2.options[i3].innerHTML == this.innerHTML) {
                    ...
                    y2 = this.parentNode.getElementsByClassName("same-as-selected");
                    yl = y2.length;
                    for (k2 = 0; k2 < yl; k2++) {
    ...
    function main$5() {
      productLinkColor();
      let description = document.querySelector(".container-info-text.description");
    ...
    function main$4() {
      ...
      document.addEventListener("pjax:switch", function() {
        ...
        document.querySelectorAll(".form-search .preenchido").forEach((element) => {
  ...
  <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn't support embedded videos.</video>`, videoFormat: "", vimeo: { byline: 1, color: "00adef", controls: 1, dnt: 1, muted: 0 }, youtube: { controls: 1, enablejsapi: 1, nocookie: 1, rel: 0, fs: 1 } }, et = ["image", "html", "ajax", "inline", "clone", "iframe", "map", "pdf", "html5video", "youtube", "vimeo", "video"];
    ...
    class Dropdown {
      ...
      initialize() {
        this.dropdownParent = document.querySelector(this.config.parentSelector);
        this.dropdownSet = this.dropdownParent.querySelector(this.config.setSelector);
        this.dropdownGet = this.dropdownParent.querySelector(this.config.getSelector);
        this.dropdownLabel = this.dropdownParent.querySelector(this.config.labelSelector);
        this.dropdownOptions = this.dropdownParent.querySelectorAll(this.config.optionsSelector);
        this.dropdownClickOutside = onClickOutside(this.dropdownParent, () => this.close(), { autoStart: false });
      }
      ...
      (function(global, factory) {
        ...
        function $2(e2, parent2) {
          return !e2 || e2.length == 0 ? (
            ...
            [].slice.call(e2[0].nodeName ? e2 : (parent2 || root).querySelectorAll(e2))
          );
        }
            ...
            if (contents.length) {
              ...
              each(contents.split(splitOn), function(splitText2, i2) {
                if (i2 && preserveWhitespace) {
                  allElements.push(createElement(F2, "whitespace", " ", preserveWhitespace));
                }
      ...
      document.querySelectorAll(".split-words:not(.splitting)").forEach((element) => {
        ...
        results[0].lines.forEach((ar, i2) => {
          ar.forEach((el, j2) => {
            ...
            el.innerHTML = '<span class="line-' + i2 + '">' + el.innerHTML + "<span>&nbsp;</span></span>";
          });
        });
    ...
    function copyLink() {
      var copyTextareaBtn = document.querySelectorAll(".container-copy:not(.js-copy-link-running)");
      copyTextareaBtn.forEach((element) => {
        element.classList.add("js-copy-link-running");
        element.querySelector(".copy-link").addEventListener("click", function(event) {
    ...
    function manualModalCloseControls() {
      document.querySelectorAll(".manual-modal-close:not(.js-modal-close-running)").forEach((element) => {

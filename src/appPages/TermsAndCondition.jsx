      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6 col-11 mx-mobile-auto offset-lg-3">
            ...
            >
              {pages &&
                termsAndConditionState === "succeeded" &&
            ...
            >
              <h2>
                {pages &&
                  termsAndConditionState === "succeeded" &&
                  pages?.terms[1].nodes[0].textData.text}
              </h2>
              <p>
                {pages &&
                  termsAndConditionState === "succeeded" &&
              ...
              <p>
                <i>
                  {pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[4].nodes[0].textData.text}
                </i>
                <a
                  href={
                    pages &&
              ...
              <blockquote cite="http://loripsum.net">
                {pages &&
                  termsAndConditionState === "succeeded" &&
                  pages?.terms[7].nodes[0].textData.text}
              </blockquote>
              <dl>
                <dt>
                  <dfn>
                    {pages &&
                      termsAndConditionState === "succeeded" &&
                      pages?.terms[9].nodes[0].textData.text}
                  </dfn>
                </dt>
                <dd>
                  {pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[10].nodes[0].textData.text}
                </dd>
                <dt>
                  <dfn>
                    {pages &&
                      termsAndConditionState === "succeeded" &&
                      pages?.terms[11].nodes[0].textData.text}
                  </dfn>
                </dt>
                <dd>
                  {pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[12].nodes[0].textData.text}
                </dd>
              </dl>
              <h3>
                {pages &&
              ...
              <p>
                {pages &&
                  termsAndConditionState === "succeeded" &&
                  pages?.terms[16].nodes[0].textData.text}
                <b>
                  {pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[16].nodes[1].textData.text}
                </b>
                <a
                  href={
                    pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[16].nodes[3].textData?.decorations[0].linkData
                      .link.url
                  }
                  target="_blank"
                  rel="noreferrer"
                >
                  {pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[16].nodes[3].textData.text}
                </a>
                {pages &&
                  termsAndConditionState === "succeeded" &&
                  pages?.terms[16].nodes[4].textData.text}
                <i>
                  {pages &&
                    termsAndConditionState === "succeeded" &&
                    pages?.terms[16].nodes[5].textData.text}
                </i>
              </p>
            </div>
